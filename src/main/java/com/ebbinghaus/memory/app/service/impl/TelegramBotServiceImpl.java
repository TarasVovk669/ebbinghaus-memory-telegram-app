...
public class TelegramBotServiceImpl implements TelegramBotService {
    ...
    private final Function<InputUserData, Boolean> handleQuizPushDisable =
            userData -> {
                ...
                telegramClientService.sendEditMessage(
                        userData.getChatId(),
                        String.format(
                                messageSourceService.getMessage("messages.profile.disable-quiz-notifications.response", userData.getLanguageCode()),
                                userData.getUser().getFirstName()),
    ...
    private final Function<InputUserData, Boolean> handleQuizPushEnable =
            userData -> {
                ...
                telegramClientService.sendEditMessage(
                        userData.getChatId(),
                        String.format(
                                messageSourceService.getMessage("messages.profile.activate-quiz-notifications.response", userData.getLanguageCode()),
                                userData.getUser().getFirstName()),
                        keyboardService.getSingleBackProfileKeyboard(userData.getLanguageCode()),
                        null,
                        userData.getMessageId());
