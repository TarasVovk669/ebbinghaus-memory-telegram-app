...
public class DateUtils {
    ...
    public static LocalDateTime calculateNextExecutionTime(EMessage eMessage) {
        return eMessage.getNextExecutionDateTime()
                .plusMinutes(INTERVAL_MAP.getOrDefault(eMessage.getExecutionStep(), DEFAULT_TIME_EXECUTION));
    }

    public static String formatDuration(
            LocalDateTime start, LocalDateTime end, String languageCode, MessageSourceService messageSourceService) {
